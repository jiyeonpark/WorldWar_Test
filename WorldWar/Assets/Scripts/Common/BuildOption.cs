...
public class BuildOption : MonoBehaviour
{
	...
	public int maxAllowedLog = 100000 ;
	...
	void Awake()
	{
		...
		selectedLogStyle.normal.textColor = Color.yellow ;
		...
		else 
		{
          ...
          //WiseLog.Init(WiseLog.LEVEL.All);
          //WiseLog.isUseLog = isUseLog;
	}
	...
	void OnGUI()
	{   
       // GUI.Label(new Rect(0, Screen.height - 25, 100, 100), string.Format("Ver : {0}", GameVersion.BUNDLE_VERSION));
       // GUI.Label( new Rect( 0, 50, Screen.width, 25 ), WiseLoader.instance.PatchRate.ToString());
