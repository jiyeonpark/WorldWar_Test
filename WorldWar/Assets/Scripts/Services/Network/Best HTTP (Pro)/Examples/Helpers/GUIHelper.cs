...
public static class GUIHelper
{
    ...
    public static void DrawArea(Rect area, bool drawHeader, Action action, string DisplayName)
    {
        Setup();
        ...
        if (drawHeader)
        {
            GUIHelper.DrawCenteredText(DisplayName);
            GUILayout.Space(5);
        }
